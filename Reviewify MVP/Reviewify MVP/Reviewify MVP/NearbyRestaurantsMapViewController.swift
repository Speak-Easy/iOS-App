...
class NearbyRestaurantsMapViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        if !AppDelegate.appDelegate().locationManager.respondsToSelector("requestWhenInUseAuthorization") {
            AppDelegate.appDelegate().locationManager.requestAlwaysAuthorization()
        }
        else {
            AppDelegate.appDelegate().locationManager.desiredAccuracy = kCLLocationAccuracyBest
            AppDelegate.appDelegate().locationManager.distanceFilter = kCLLocationAccuracyBest
            AppDelegate.appDelegate().locationManager.startUpdatingLocation()
            AppDelegate.appDelegate().locationManager.delegate = self
            
            if let location = AppDelegate.appDelegate().locationManager.location?.coordinate {
